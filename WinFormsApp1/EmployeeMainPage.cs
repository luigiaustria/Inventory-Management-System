...
namespace WinFormsApp1
{
    public partial class EmployeeMainPage : Form
    {
        ...
        public EmployeeMainPage(string value)
        {
            InitializeComponent();
            CollapseMenu();
        ...
        private void EmployeeMainPage_Resize(object sender, EventArgs e)
        {
            AdjustForm();
        }
        ...
        {
            ActivateButton(sender, Color.White);
            openChildForm(new EmployeeEL(lblUsername.Text));
        ...
        {
            ActivateButton(sender, Color.White);
            openChildForm(new EmployeeInventory());
